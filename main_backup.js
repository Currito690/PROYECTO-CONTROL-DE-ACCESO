...
window.handlePunch = async function(type) {
  ...
  if (!navigator.geolocation) {
    alert('Tu navegador no soporta geolocalizaci?n o est? desactivada.');
  ...
  navigator.geolocation.getCurrentPosition(async (position) => {
    ...
    alert('No se ha podido obtener tu ubicaci?n GPS (necesario para fichar y verificar tu posici?n). Por favor da permiso a tu navegador.');
    if(btn) { btn.disabled = false; btn.textContent = 'Reintentar'; }
  });
};
